                            ...
                            <el-col :span="20">
                                <div class="grid-content">
                                    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px"
                                        class="demo-ruleForm">
                                        <el-form-item label="题 干：" prop="Question_stem">
                                        ...
                                        <el-row>
                                            <el-col :span="15">
                                                <div class="grid-content ">
                                                    <el-form-item label="选 项 A：" prop="optionA">
                                        ...
                                        <el-row>
                                            <el-col :span="15">
                                                <div class="grid-content">
                                                    <el-form-item label="选 项 B：" prop="optionB">
                                        ...
                                        <el-row>
                                            <el-col :span="15">
                                                <div class="grid-content ">
                                                    <el-form-item label="选 项 C：" prop="optionC">
                                        ...
                                        <el-row>
                                            <el-col :span="15">
                                                <div class="grid-content ">
                                                    <el-form-item label="选 项 D：" prop="optionD">
                                        ...
                                        <el-form-item label="正确答案：" prop="Correct_answer">
                                            <el-checkbox-group v-model="ruleForm.Correct_answer" style="display:flex;flex-direction:row;justify-content: start;">
                                                <el-checkbox label="A" name="Correct_answer"></el-checkbox>
                                                <el-checkbox label="B" name="Correct_answer"></el-checkbox>
                                                <el-checkbox label="C" name="Correct_answer"></el-checkbox>
                                                <el-checkbox label="D" name="Correct_answer"></el-checkbox>
                                            </el-checkbox-group>
                                        </el-form-item>
                                        ...
                                        <el-form-item style="display: flex;flex-direction: row;justify-content: end;">
                                            <el-button type="primary" @click="submitForm('ruleForm')">保存多选题</el-button>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                Correct_answer: [
                    { type: 'array', required: true, message: '请至少选择俩个选项', trigger: 'change' }
                ],
